...
-type(amqp_method_field_name() ::
       ...
       | exchange | routing_key | ticket | queue
       | no_ack | delivery_tag | redelivered | exchange
       | routing_key | message_count | cluster_id | delivery_tag
       | multiple | delivery_tag | requeue | requeue
       | requeue )).
