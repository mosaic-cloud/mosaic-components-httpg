...
-type(amqp_method_field_name() ::
       ...
       | message_count | cluster_id | delivery_tag | multiple
       | delivery_tag | requeue | requeue | requeue
       | delivery_tag | multiple | requeue | version_major
       | version_minor | server_properties | locales | mechanisms
       | client_properties | response | mechanism | locale
       | challenge | response | nowait | channel_max
